...
// Vérifier si on clique sur la croix pour libérer la table
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["table_id"])) {
    $table_id = intval($_POST["table_id"]);

    // Mettre la table en "disponible"
    $sql = "UPDATE Tables SET disponible = 1 WHERE table_id = ?";
...
// Récupérer les commandes en attente avec leur statut
